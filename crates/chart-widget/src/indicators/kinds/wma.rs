...
use chart_core::{
    ...
    ParamValues, Rgba, compute_wma_indicator,
};
...
pub const ID: &str = "wma";
pub const NAME: &str = "WMA";
pub const LIKES: u32 = 8432;
    ...
    fields: &[
        ...
        ParamField {
            ...
            kind: ParamKind::Color {
                default: Rgba::from_rgb(233, 30, 99),
            },
        },
    ],
};
...
impl Indicator for Wma {
    ...
    fn compute(&self, inputs: &[&[f32]], params: &ParamValues) -> ComputedSeries {
        ...
        let series = compute_wma_indicator(closes, period);
        let mut out = ComputedSeries::default();
        out.series.insert("wma", series);
        out
    }
    ...
    fn draw_main(
        ...
        let Some(series) = computed.series.get("wma") else {
            return;
        };
    ...
    fn legend(
        ...
        match series.get(idx).and_then(|v| *v) {
            Some(v) => vec![LegendEntry {
                label: format!("WMA{} {:.2}", params.int("period"), v),
