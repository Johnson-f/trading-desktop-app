//! Async candle loader — bridges `api_client::historical_bars`
...
use api_client::{ApiClient, BarUnit, BucketInput, HistoricalBar};
use chart_core::{BaseScale, CandleData, CandleInstance};
